...
<head>
    ...
    <link rel="stylesheet" href="resource/concept-master/assets/vendor/fonts/fontawesome/css/fontawesome-all.css">
    <link rel="stylesheet" href="resource/concept-master/assets/vendor/charts/morris-bundle/morris.css">
	            ...
	            <div class="collapse navbar-collapse " id="navbarSupportedContent">
	                <ul class="navbar-nav ml-auto navbar-right-top">
	                                    ...
	                                    <div class="list-group">
	                                        <a href="#" class="list-group-item list-group-item-action active">
	                                            <div class="notification-info">
	                                                <div class="notification-list-user-img"><img src="resource/concept-master/assets/images/avatar-2.jpg" alt="" class="user-avatar-md rounded-circle"></div>
	                                        ...
	                                        <a href="#" class="list-group-item list-group-item-action">
	                                            <div class="notification-info">
	                                                <div class="notification-list-user-img"><img src="resource/concept-master/assets/images/avatar-3.jpg" alt="" class="user-avatar-md rounded-circle"></div>
	                                        ...
	                                        <a href="#" class="list-group-item list-group-item-action">
	                                            <div class="notification-info">
	                                                <div class="notification-list-user-img"><img src="resource/concept-master/assets/images/avatar-4.jpg" alt="" class="user-avatar-md rounded-circle"></div>
	                                        ...
	                                        <a href="#" class="list-group-item list-group-item-action">
	                                            <div class="notification-info">
	                                                <div class="notification-list-user-img"><img src="resource/concept-master/assets/images/avatar-5.jpg" alt="" class="user-avatar-md rounded-circle"></div>
	                            ...
	                            <li class="connection-list">
	                                <div class="row">
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/github.png" alt="" > <span>Github</span></a>
	                                    </div>
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/dribbble.png" alt="" > <span>Dribbble</span></a>
	                                    </div>
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/dropbox.png" alt="" > <span>Dropbox</span></a>
	                                    </div>
	                                </div>
	                                <div class="row">
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/bitbucket.png" alt=""> <span>Bitbucket</span></a>
	                                    </div>
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/mail_chimp.png" alt="" ><span>Mail chimp</span></a>
	                                    </div>
	                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
	                                        <a href="#" class="connection-item"><img src="resource/concept-master/assets/images/slack.png" alt="" > <span>Slack</span></a>
	                                    </div>
	                                </div>
	                            </li>
	                            <li>
	                    ...
	                    <li class="nav-item dropdown nav-user">
	                        <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="resource/concept-master/assets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a>
	        ...
	        <div class="dashboard-influence">
	            <div class="container-fluid dashboard-content">
	                ...
	                <div class="row">
	                                ...
	                                <div class="row">
	                                    <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
	                                        <div class="text-center">
	                                            <img src="resource/concept-master/assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xxl">
	                                            </div>
	                                        </div>
	                                ...
	                                <div class="campaign-table table-responsive">
	                                    <table class="table">
	                                        ...
	                                        <tbody>
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="resource/concept-master/assets/images/dribbble.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="resource/concept-master/assets/images/github.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="resource/concept-master/assets/images/dropbox.png" alt="user" width="35"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="resource/concept-master/assets/images/bitbucket.png" alt="user" width="30"></div>
	                                                </td>
	                                            ...
	                                            <tr>
	                                                <td>
	                                                    <div class="m-r-10"><img src="resource/concept-master/assets/images/mail_chimp.png" alt="user" width="30"></div>
	                                                </td>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                            <div class="card campaign-card text-center">
	                                <div class="card-body">
	                                    <div class="campaign-img"><img src="resource/concept-master/assets/images/dribbble.png" alt="user" class="user-avatar-xl"></div>
	                            ...
	                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                <div class="card campaign-card text-center">
	                                    <div class="card-body">
	                                        <div class="campaign-img"><img src="resource/concept-master/assets/images/github.png" alt="user" class=" user-avatar-xl"></div>
	                                            <div class="campaign-info">
	                                                <h3 class="mb-1">Campaigns Name</h3>
	                                ...
	                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                    <div class="card campaign-card text-center">
	                                        <div class="card-body">
	                                            <div class="campaign-img"><img src="resource/concept-master/assets/images/slack.png" alt="user" class="user-avatar-xl"></div>
	                                                <div class="campaign-info">
	                                                    <h3 class="mb-1">Campaigns Name</h3>
	                                    ...
	                                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
	                                        <div class="card campaign-card text-center">
	                                            <div class="card-body">
	                                                <div class="campaign-img"><img src="resource/concept-master/assets/images/mail_chimp.png" alt="user" class="user-avatar-xl"></div>
	                                                    <div class="campaign-info">
	                                                        <h3 class="mb-1">Campaigns Name</h3>
	                    ...
	                    <!-- slimscroll js -->
	                    <script src="resource/concept-master/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
	                    <!-- main js -->
	                    <script src="resource/concept-master/assets/libs/js/main-js.js"></script>
	                    <!-- morris-chart js -->
	                    <script src="resource/concept-master/assets/vendor/charts/morris-bundle/raphael.min.js"></script>
	                    ...
	                    <!-- chart js -->
	                    <script src="resource/concept-master/assets/vendor/charts/charts-bundle/Chart.bundle.js"></script>
	                    <script src="resource/concept-master/assets/vendor/charts/charts-bundle/chartjs.js"></script>
	                    <!-- dashboard js -->
	                    <script src="resource/concept-master/assets/libs/js/dashboard-influencer.js"></script>
</body>
