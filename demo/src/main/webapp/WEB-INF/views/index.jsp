...
<body>
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="index">E Commerce Dashboard</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="ecommerceProduct">Product List</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="ecommerceProductSingle">Product Single</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="ecommerceProductCheckout">Product Checkout</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="dashboardFinance">Finance</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="dashboardSales">Sales</a>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-1-1" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="dashboardInfluencer">Influencer</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="influencerFinder">Influencer Finder</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="influencerProfile">Influencer Profile</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
    ...
    <script src="resource/concept-master/assets/vendor/charts/c3charts/C3chartjs.js"></script>
    <script src="resource/concept-master/assets/libs/js/dashboard-ecommerce.js"></script>
</body>
